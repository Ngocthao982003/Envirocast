...
class SelectItemOperator(bpy.types.Operator):
    bl_idname = "envirocast.select_item"
...
class UseItemOperator(bpy.types.Operator):
    ...
    def execute(self, context):
        ...
        col.envirocast.is_envirocast_asset = True
        col.envirocast.asset_id = target.asset_id
...
class ClearTagsOperator(bpy.types.Operator):
    bl_idname = "envirocast.clear_tags"
    bl_label = "Clear Tags"
...
class ScrollDetailsOperator(bpy.types.Operator):
    bl_idname = "envirocast.scroll_details"
