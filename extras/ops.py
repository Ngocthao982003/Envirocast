...
class RealizeSystemOperator(bpy.types.Operator):
    bl_idname = "envirocast.realize_scatter_system"
    ...
    def poll(cls, context: bpy.types.Context):
        ...
        if (
            ...
            and active_object.envirocast.is_envirocast_system
        ):
            return True
        return False
...
class ApplySystemOperator(bpy.types.Operator):
    bl_idname = "envirocast.apply_scatter_system"
    ...
    def execute(self, context):
        ...
        merged_obj.envirocast.is_envirocast_system = False
        ...
        envirocast_node_group = new_system_tree.nodes.get("EnviroCast")

        new_system_tree.links.new(
            real_inst_node.inputs[0], envirocast_node_group.outputs[0]
        )
